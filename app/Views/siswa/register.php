...
<main>
    <div class="row m-0 position-relative">
        ...
        <form action="/examify-platform-ujian/siswa/register" method="POST" class="col d-flex flex-column align-items-center position-relative justify-content-center">
